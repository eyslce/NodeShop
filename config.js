var config = {
    ...
    goodsLibrary: {
        ...
        male_coat: {favorites_id: 3195761, favorites_title: '男款外套', type: 1},
        tea: {favorites_id: 3195665, favorites_title: '茶叶咖啡', type: 1},
        cooked_food: {favorites_id: 3195408, favorites_title: '肉类熟食', type: 1},
        snacks: {favorites_id: 3195271, favorites_title: '零食礼包', type: 1},
        nuts: {favorites_id: 3195196, favorites_title: '坚果枣干', type: 1},
        lady_bags: {favorites_id: 3162392, favorites_title: '女包', type: 1},
        lady_shoes: {favorites_id: 3162389, favorites_title: '女鞋', type: 1},
        pregnant_mother_supplies: {favorites_id: 3162384, favorites_title: '孕妈用品', type: 1},
        fancy_toy: {favorites_id: 3162379, favorites_title: '益智玩具', type: 1},
        children_garment: {favorites_id: 3162373, favorites_title: '儿童服装', type: 1},
        baby_products: {favorites_id: 3162371, favorites_title: '婴儿用品', type: 1},
