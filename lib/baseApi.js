...
function baseApi() {
     ...
     * }
     */
    this.getItemInfo = function (params) {
        var defaultParam = {
            'fields': 'num_iid,title,pict_url,small_images,reserve_price,zk_final_price,user_type,provcity,item_url'
        };
     ...
     * }
     */
    this.getItemRecommend = function (params) {
        var defaultParam = {
            'fields': 'num_iid,title,pict_url,small_images,reserve_price,zk_final_price,user_type,provcity,item_url'
        };
     ...
     * }
     */
    this.getEventUatm = function (params) {
        var defaultParam = {
            'fields': 'event_id,event_title,start_time,end_time'
        };
     ...
     * }
     */
    this.getItemEventUatm = function (params) {
        var defaultParam = {
     ...
     * }
     */
    this.getItemFavoritesUatm = function(params){
        var defaultParam = {
            'fields': 'num_iid,title,pict_url,small_images,reserve_price,zk_final_price,user_type,provcity,' +
